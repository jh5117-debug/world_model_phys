...
class Trainer:
    ...
    def _init_distributed(self):
        ...
        assert report_to == "wandb", "For this project, wandb is used"  # Tensorboard is also ok by deleting this line 
    ...
    def prepare_trackers(self) -> None:
        ...
        run_name = f"{self.args.model_name}-2b-{self.args.loss}{self.args.comment}-{self.args.align_models[0]}-{datetime.now().strftime('%m/%d-%H-%M')}"
        self.accelerator.init_trackers( # For wandb setting and others ...
            tracker_name,
