...
class AutoencoderKLCogVideoX(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def _encode(self, x: torch.Tensor) -> torch.Tensor:
        ...
        for i in range(num_batches):
            ...
            start_frame = frame_batch_size * i + (0 if i == 0 else remaining_frames)    # 0
            end_frame = frame_batch_size * (i + 1) + remaining_frames   # 9
            x_intermediate = x[:, :, start_frame:end_frame] # B, C, F, H, W
