...
class Args(BaseModel):
    ...
    def parse_args(cls):
        ...
        parser.add_argument("--loss", type=str, default="cosine", choices=["token_relation_distillation", "token_relation_distillation_only_spatial", "token_relation_distillation_only_temporal", "cosine_similarity"])
