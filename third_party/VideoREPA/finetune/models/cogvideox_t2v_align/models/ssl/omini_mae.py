...
try:
    from finetune.models.cogvideox_t2v_align.models.ssl.omini_vision_transformer import (
        Attention,
        Decoder,
        PadIm2Video,
        VisionTransformer,
    ...
    from omini_vision_transformer import (
        Attention,
        Decoder,
        PadIm2Video,
        VisionTransformer,
...
def vit_base_mae_pretraining(pretrained=True):
    ...
    trunk = VisionTransformer(
        ...
        use_cls_token=False,    # NOTE the false
        ...
        layer_norm_eps=1e-6,
        masked_image_modeling=True, # NOTE here
...
if __name__ == '__main__':
    model = vit_base_mae_pretraining().cuda()
    
    input_tensor = torch.randn([1, 3, 48, 160, 240]).cuda() # B, C, F, H, W
    print("model loaded!!!!")