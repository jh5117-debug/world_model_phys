...
try:
    from finetune.models.cogvideox_t2v_align.models.ssl.utils.patch_embed import PatchEmbed, PatchEmbed3D
    from finetune.models.cogvideox_t2v_align.models.ssl.utils.modules import Block
    from finetune.models.cogvideox_t2v_align.models.ssl.utils.pos_embs import get_2d_sincos_pos_embed, get_3d_sincos_pos_embed
except:
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, masks=None):
        ...
        if self.out_layers is not None:
            raise NotImplementedError("Disabled for current experiment")
            return outs
