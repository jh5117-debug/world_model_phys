...
class CogVideoXTransformer3DModelAlign(CogVideoXTransformer3DModel, ModelMixin):
    ...
    def forward(
        ...
        for i, block in enumerate(self.transformer_blocks):
            ...
            if (i + 1) == self.align_layer:
                new_aligns = [projector(hidden_states).flatten(0, 1) for projector in self.projectors]
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        try:
            ...
            config["align_layer"] = kwargs.pop("align_layer")
            config["align_dims"] = kwargs.pop("align_dims")
            config["projector_dim"] = kwargs.pop("projector_dim")
