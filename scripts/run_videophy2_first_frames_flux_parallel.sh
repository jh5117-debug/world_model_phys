...
HF_XET_CLIENT_RETRY_MAX_ATTEMPTS="${HF_XET_CLIENT_RETRY_MAX_ATTEMPTS:-10}"
HF_XET_CLIENT_READ_TIMEOUT="${HF_XET_CLIENT_READ_TIMEOUT:-600}"
HF_XET_FIXED_DOWNLOAD_CONCURRENCY="${HF_XET_FIXED_DOWNLOAD_CONCURRENCY:-2}"
...
echo "[INFO] TURBO_LORA_ID=${TURBO_LORA_ID}"
echo "[INFO] HF_ENDPOINT=${HF_ENDPOINT:-<default>}"
echo "[INFO] HF_HUB_DISABLE_XET=${HF_HUB_DISABLE_XET}"
echo "[INFO] HF_HUB_DOWNLOAD_TIMEOUT=${HF_HUB_DOWNLOAD_TIMEOUT}"
echo "[INFO] HF_XET_CLIENT_RETRY_MAX_ATTEMPTS=${HF_XET_CLIENT_RETRY_MAX_ATTEMPTS}"
echo "[INFO] HF_XET_CLIENT_READ_TIMEOUT=${HF_XET_CLIENT_READ_TIMEOUT}"
echo "[INFO] HF_XET_FIXED_DOWNLOAD_CONCURRENCY=${HF_XET_FIXED_DOWNLOAD_CONCURRENCY}"
...
for shard_idx in "${!GPUS[@]}"; do
  ...
  HF_XET_CLIENT_RETRY_MAX_ATTEMPTS="${HF_XET_CLIENT_RETRY_MAX_ATTEMPTS}" \
  HF_XET_CLIENT_READ_TIMEOUT="${HF_XET_CLIENT_READ_TIMEOUT}" \
  HF_XET_FIXED_DOWNLOAD_CONCURRENCY="${HF_XET_FIXED_DOWNLOAD_CONCURRENCY}" \
